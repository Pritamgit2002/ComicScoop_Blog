          ...
          >
            <motion.div
              ...
              className={cn(
                ...
                selected?.id === card.id
                  ? "rounded-lg cursor-pointer absolute inset-x-0 inset-y-auto bg-black h-1/2 w-full md:w-1/2 m-auto z-50 flex justify-center items-center flex-wrap flex-col border-2 border-gray-200 shadow-md shadow-gray-300 "
